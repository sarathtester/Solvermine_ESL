package longtermCreation_scripts;
...
public class TC_Long_Term_Creation_LT04 extends Keywords{
	String url = TestNgXml.getdatafromExecution().get("TC_Long_Term_Creation_LT04");
	...
	public void vSS_LT04(WebDriver driver){
//Login
