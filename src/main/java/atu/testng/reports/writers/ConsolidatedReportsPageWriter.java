...
public class ConsolidatedReportsPageWriter extends ReportsPage {
				...
				for (int j = paramInt; j >= i; --j) {
					...
					if (j == paramInt) {
						paramPrintWriter.println("\n <li style=\"padding-top: 4px;padding-bottom: 4px;\"><a href=\""
								+ Directory.RUNName + (j - i + 1) + Directory.SEP + "CurrentRun.html\" >" + "Run "
								+ (j - i + 1) + " </a></li>\n");
						break;
					}
					paramPrintWriter.println("\n <li class=\"menuStyle\"><a href=\"" + Directory.RUNName + (j - i + 1)
	...
	public static void header(PrintWriter paramPrintWriter) {
		paramPrintWriter.println(
				...
				+ "<div style=\"padding-right:20px;float:right\"><img src=\"../HTML_Design_Files/IMG/Solverminds.jpg"
