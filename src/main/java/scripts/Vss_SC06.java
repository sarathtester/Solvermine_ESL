...
public class Vss_SC06 extends Keywords {
	String url = TestNgXml.getdatafromExecution().get("Testcase1");
 	...
 	String Frequ = Utils.getDataFromTestData("ESL", "Freqency","Sheet4");
	String NoShips = Utils.getDataFromTestData("ESL", "NoOfShips","Sheet4");
	String ServiceDelete = Utils.getDataFromTestData("ESL", "ServiceDelete","Sheet4");
