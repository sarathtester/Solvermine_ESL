...
public class Long_Term_Creation_LT01  extends Keywords{
	...
	click(driver, OKK);
		...
		new Actions(driver).sendKeys("Voyageinputinc1").perform();
		...
		waitForElement(driver, Voyageinput1fill);
		WebElement Mousee= driver.findElement(By.xpath("((//tr[@data-ri='7'])[1]//following::td)[5]"));
		action.moveToElement(Mousee);
	
		
		 WebElement voyage = driver.findElement(By.xpath("(//*[@col-id='voyageCode'])[2]"));
			String one=voyage.getText();
			 WebElement voyage2 = driver.findElement(By.xpath("(//*[@col-id='voyageCode'])[3]"));
				String one2=voyage.getText();
				 WebElement voyage3 = driver.findElement(By.xpath("(//*[@col-id='voyageCode'])[4]"));
					String one3=voyage3.getText();
					 WebElement voyage4 = driver.findElement(By.xpath("(//*[@col-id='voyageCode'])[5]"));
						String one4=voyage4.getText();
		 WebElement voyage5 = driver.findElement(By.xpath("((//tr[@data-ri='7'])[1]//following::td)[1]"));
			String one5=voyage5.getText();
			 WebElement voyage6 = driver.findElement(By.xpath("((//tr[@data-ri='7'])[1]//following::td)[2]"));
				String one6=voyage6.getText();
				 WebElement voyage7 = driver.findElement(By.xpath("((//tr[@data-ri='7'])[1]//following::td)[3]"));
					String one7=voyage7.getText();
					 WebElement voyage8 = driver.findElement(By.xpath("((//tr[@data-ri='7'])[1]//following::td)[4]"));
						String one8=voyage8.getText();
						System.out.println(one +"-"+one5);
						System.out.println(one2 +"-"+one6);
						System.out.println(one3 +"-"+one7);
						System.out.println(one4 +"-"+one8);
			
						 WebElement voyage9 = driver.findElement(By.xpath("((//tr[@data-ri='7'])[1]//following::td)[5]"));
							String one9=voyage9.getText();
							 WebElement voyage14 = driver.findElement(By.xpath("((//tr[@data-ri='7'])[1]//following::td)[6]"));
								String one14=voyage14.getText();
								 WebElement voyage15 = driver.findElement(By.xpath("((//tr[@data-ri='7'])[1]//following::td)[7]"));
									String one15=voyage15.getText();
									 WebElement voyage16 = driver.findElement(By.xpath("((//tr[@data-ri='7'])[1]//following::td)[8]"));
										String one16=voyage16.getText();
							 WebElement voyage10 = driver.findElement(By.xpath("(//*[@col-id='incVoyage'])[2]"));
								String one10=voyage10.getText();
								 WebElement voyage11 = driver.findElement(By.xpath("(//*[@col-id='incVoyage'])[3]"));
									String one11=voyage11.getText();
									 WebElement voyage12 = driver.findElement(By.xpath("(//*[@col-id='incVoyage'])[4]"));
										String one12=voyage12.getText();
										 WebElement voyage13 = driver.findElement(By.xpath("(//*[@col-id='incVoyage'])[5]"));
											String one13=voyage13.getText();
			
								System.out.println(one +"+"+one10+"="+one9);
								System.out.println(one2 +"+"+one11+"="+one14);
								System.out.println(one3 +"+"+one12+"="+one15);
								System.out.println(one4 +"+"+one13+"="+one16);
								
								waitForElement(driver, LongTermSave);
								//click(driver, LongTermSave);
//								waitForElement(driver, LongTermSavepop);
//								System.out.println(LongTermSavepop);
//								click(driver, LongTermSavepopOK);
//								
