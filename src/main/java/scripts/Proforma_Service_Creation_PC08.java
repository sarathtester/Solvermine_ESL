...
public class Proforma_Service_Creation_PC08 extends Keywords{
	...
	String Servicenamein = Utils.getDataFromTestData("Equipment_Details", "Servicenameinput", "Sheet3");
	String Portcodefilter = Utils.getDataFromTestData("Datas_Details", "PortCodeFilter", "Sheet3");
	String Portcodefilter1 = Utils.getDataFromTestData("Datas_Details", "Portcodesearch", "Sheet3");
	String Portcodefilter2 = Utils.getDataFromTestData("Datas_Details", "Portcodesearch1", "Sheet3");
...
click(driver, OKK);
	...
	System.out.println(word);
		...
		click(driver, Searchtable);
		wait(driver, "1");
//		waitForElement(driver, nUMBERCODE1);
//		click(driver, nUMBERCODE1);
		waitForElement(driver, SelectOkBtn);
		click(driver, SelectOkBtn);
		wait(driver, "2");
...
//	}
//	waitForElement(driver, ProformaCodeInput);
//	sendKeys(driver, ProformaCodeInput, ProformaCodeConformInput);
//	
//	waitForElement(driver, Searchtable);
//	click(driver, Searchtable);
//	wait(driver, "1");
//	waitForElement(driver, nUMBERCODE2);
//	click(driver, nUMBERCODE2);
//	waitForElement(driver, SelectOkBtn);
//	click(driver, SelectOkBtn);
//	wait(driver, "2");
//	
