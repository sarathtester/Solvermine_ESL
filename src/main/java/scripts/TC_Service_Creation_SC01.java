...
public class TC_Service_Creation_SC01 extends Keywords{
	...
	String ServiceCode = Utils.getDataFromTestData("SOLVERMINDS", "Service_Code","Sheet1");
	String ServiceName = Utils.getDataFromTestData("SOLVERMINDS", "Service_Name","Sheet1");
	String Frequ = Utils.getDataFromTestData("SOLVERMINDS", "Freqency","Sheet1");
	String NoShips = Utils.getDataFromTestData("SOLVERMINDS", "No_of_Ships","Sheet1");
