...
public interface Booking_Locators1 extends EMS_Locators,VSS_Locator {
	//Login page
	public static String username_l="username >//*[@id='nfr_login_authname']";
	public static String password_l="password >//*[@id='nfr_login_authid']";
	public static String Login_btn_l="Login_btn >//*[@id='nfr_login_btnlogin']";
	//Home page
	...
	public static String  ServiceInput="ServiceInput>//input[contains(@id,'ag-input-id-1533')]";
	...
	public static String bookingNo_l="bookingNo_l>//input[@id='BKG-BKG_txtBookingNo']";
}
