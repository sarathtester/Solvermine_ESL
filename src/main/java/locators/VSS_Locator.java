...
public interface VSS_Locator {
	...
	//Proforma service creation
	  ...
	  public static String wantToCreatePopup="wantToCreatePopup>//h2[.='Proforma Service Creation']";
	  public static String createOk="createOk>//button[.='Yes']/following::span[.=' Do you want to create a new Proforma Service Creation?']";
